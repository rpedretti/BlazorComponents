...
namespace BlazorApp30.Components.BackgroundContent
{
    ...
    {
        [Parameter]
        protected BackgroundContentType Type { get; set; } = BackgroundContentType.SUCCESS;

        [Parameter]
        protected RenderFragment ChildContent { get; set; }

        [Parameter]
        protected Color ParentBgColor { get; set; } = Color.Transparent;

        [Parameter]
        protected Color ChildBgColor { get; set; } = Color.Transparent;
